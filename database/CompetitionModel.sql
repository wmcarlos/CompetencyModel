...
CREATE TABLE cm_domain_level(
	...
	CONSTRAINT fk_company_id04 FOREIGN KEY (comapny_id) REFERENCES cm_company (company_id) ON UPDATE CASCADE ON DELETE RESTRICT
)ENGINE = INNODB;
...
CREATE TABLE cm_development_level(
	...
	CONSTRAINT fk_company_id06 FOREIGN KEY (comapny_id) REFERENCES cm_company (company_id) ON UPDATE CASCADE ON DELETE RESTRICT
)ENGINE = INNODB;
...
CREATE TABLE cm_competency(
	...
	CONSTRAINT fk_company_id07 FOREIGN KEY (comapny_id) REFERENCES cm_company (company_id) ON UPDATE CASCADE ON DELETE RESTRICT,
	CONSTRAINT fk_charge_level_id FOREIGN KEY (charge_level_id) REFERENCES cm_charge_level (charge_level_id) ON UPDATE CASCADE ON DELETE RESTRICT
)ENGINE = INNODB;
...
CREATE TABLE cm_behavioral_indicator(
	...
	CONSTRAINT fk_development_level_id FOREIGN KEY (development_level_id) REFERENCES cm_development_level (development_level_id) ON UPDATE CASCADE ON DELTE RESTRICT
)ENGINE = INNODB;
...
CREATE TABLE cm_instrument_of_evaluation(
	...
	CONSTRAINT fk_company_id08 FOREIGN KEY (comapny_id) REFERENCES cm_company (company_id) ON UPDATE CASCADE ON DELETE RESTRICT,
