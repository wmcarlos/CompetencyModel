    ...
    <div class="box">
      ...
      <table class="table table-bordered table-striped">
        ...
        <!--Desde HTML-->
          ...
          <!--Generado desde PHP-->
          <?php foreach($dtlitems AS $dtlitem){ ?>
              <tr>
                <td>
                  <?= $dtlitem->description ?>
                  <input type="hidden" name="txtdescriptions[]" value="<?= $dtlitem->description ?>"> 
                </td>
                <td>
                    <?= $dtlitem->development_level ?>
                    <input type="hidden" name="txtdevelopment_level[]" value="<?= $dtlitem->development_level_id ?>">
                </td>
                <td>
                  <?= $dtlitem->position ?>
                  <input type="hidden" name="txtpositions[]" value="<?= $dtlitem->position ?>">
                </td>
                <td><button class="btn btn-danger fr_button_remove" type="button"><i class="fa fa-times"></i></button></td>
              </tr>
          <?php } ?>
