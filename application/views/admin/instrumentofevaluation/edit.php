                  ...
                  <tr class="tr_padre">
                    ...
                    <td>
                      <button class="btn btn-danger fr_button_remove" type="button"><i class="fa fa-times"></i></button>
                            ...
                            <!--Generado desde PHP-->
              <tbody>
              <?php foreach($dtcompetencies AS $competency) { ?>
                <tr>
                    <td>
                      <?= $competency->competency ?>
                      <input type="hidden" name="txtcompetencies[]" value="<?= $competency->competency_id ?>">
                    </td>
                    <td>
                      <?= $competency->position ?>
                      <input type="hidden" name="txtpositions[]" value="<?= $competency->position ?>">
                    </td>
                    <td>
                      <button class="btn btn-danger fr_button_remove" type="button"><i class="fa fa-times"></i></button>
                    </td>
