<div class="content-wrapper">
  <section class="content">
    <div class="box">
      ...
      <div class="box-body">
      <?= form_open_multipart("Domainlevels/$action",array('autocomplete' => 'off')) ?>

      <div class='form-group'>
        <label for="txtcompany_id">Compa&ntilde;ia:</label>
        <input type="hidden" name="txtdomain_level_id" id="txtdomain_level_id" value = "<?= $item[0]->domain_level_id ?>">
      ...
      <div class='form-group'>
        <label for="txtscale">Escala:</label>
        <input type="text" class="form-control textuppercase" value="<?= $item[0]->scale ?>" name="txtscale" id="txtscale">
      </div>
      <div class='form-group'>
      ...
      <a class="btn btn-danger" href="<?= base_url() ?>index.php/Domainlevels"><i class="fa fa-times" aria-hidden="true"></i> Cancelar</a>
