  ...
  <section class="content">
    <div class="box">
      ...
      <div class='form-group'>
        ...
        <input type="text" class="form-control textuppercase" name="txtscale" id="txtscale">
      </div>
      <div class='form-group'>
        <label for="txtposition">Posicion:</label>
        <input type="text" class="form-control textuppercase" name="txtposition" id="txtposition">
      </div>
      <div class='form-group'>
